...
public class lab03 {
    public static void main (String[] args) {
        ...
        int cardNum;
        String[] cards = new String[] {"Ace of Clubs", "2 of Clubs", "3 of Clubs", "4 of Clubs", "5 of Clubs", "6 of Clubs", "7 of Clubs", 
        ...
        System.out.println("The card you selected was the " + cards[cardNum-1] + ".");
        System.out.print("---------------------------------------------");
